...
def train():
    ...
    #model and optimizer
    model = GCN(dataset.num_features, args.hidden_dim, dataset.num_classes, args.dropout).to(device)
...
def get_args():
    ...
    parser.add_argument('--dataset', type=str, default='Cora', help='which dataset to be used:Cora, CiteSeer, PubMed')

...
def train():
    ...
    model = GAT(dataset.num_features, args.hidden_dim, args.heads, args.dropout, int(dataset.num_classes)).to(device)
...
def get_args():
    ...
    parser.add_argument('--hidden_dim', type=int, default=8, help='Number of hidden units.')
